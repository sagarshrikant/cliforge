...
```
ext install shrikant-sagar.cliforge-schema-ext
```
...
cd cliforge/tools/vscode-schema-ext
npm install
npm run package          # produces cliforge-schema-ext-<version>.vsix
code --install-extension cliforge-schema-ext-*.vsix
```
